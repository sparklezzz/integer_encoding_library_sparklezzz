/*
 * KScheme_2Bit_Binary.hpp
 *
 *  Created on: 2013-3-2
 *      Author: zxd
 */

#ifndef KSCHEME_2BIT_BINARY_HPP_
#define KSCHEME_2BIT_BINARY_HPP_
...
class KScheme_2Bit_Binary: public Compressor {
public:
	KScheme_2Bit_Binary() {
	}
	virtual ~KScheme_2Bit_Binary() {
	}
...
template<typename T>
int KScheme_2Bit_Binary::encode(char* des, const T* src, uint32_t encodeNum) {
	if (encodeNum < 4) {
...
template<typename T>
int KScheme_2Bit_Binary::decode(T* des, const char* src, uint32_t decodeNum) {
	if (decodeNum < 4) {
...
template<typename T>
int KScheme_2Bit_Binary::encodeBlock(char* des, const T* src, uint32_t encodeNum) {
...
template<typename T>
int KScheme_2Bit_Binary::decodeBlock(T* des, const char* src, uint32_t decodeNum) {
...
#endif /* KSCHEME_2BIT_BINARY_HPP_ */
