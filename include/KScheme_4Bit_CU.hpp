...
#ifndef KSCHEME_4BIT_CU_HPP_
#define KSCHEME_4BIT_CU_HPP_
...
class KScheme_4Bit_CU: public Compressor {
public:
	KScheme_4Bit_CU() {
	}
	virtual ~KScheme_4Bit_CU() {
	}
...
template<typename T>
int KScheme_4Bit_CU::encode(char* des, const T* src, uint32_t encodeNum) {
	if (encodeNum < 4) {
...
template<typename T>
int KScheme_4Bit_CU::decode(T* des, const char* src, uint32_t decodeNum) {
	if (decodeNum < 4) {
...
template<typename T>
int KScheme_4Bit_CU::encodeBlock(char* des, const T* src, uint32_t encodeNum) {
...
template<typename T>
int KScheme_4Bit_CU::decodeBlock(T* des, const char* src, uint32_t decodeNum) {
