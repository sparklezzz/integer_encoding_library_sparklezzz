...
#ifndef SIMD_KSCHEME_4BIT_CU_HPP_
#define SIMD_KSCHEME_4BIT_CU_HPP_
...
class SIMD_KScheme_4Bit_CU: public Compressor {
public:
	SIMD_KScheme_4Bit_CU() {
	}
	virtual ~SIMD_KScheme_4Bit_CU() {
	}
...
template<typename T>
int SIMD_KScheme_4Bit_CU::encode(char* des, const T* src, uint32_t encodeNum) {
	if (encodeNum < 4) {
...
template<typename T>
int SIMD_KScheme_4Bit_CU::decode(T* des, const char* src, uint32_t decodeNum) {
	if (decodeNum < 4) {
...
template<typename T>
int SIMD_KScheme_4Bit_CU::encodeBlock(char* des, const T* src, uint32_t encodeNum) {
...
template<typename T>
int SIMD_KScheme_4Bit_CU::decodeBlock(T* des, const char* src, uint32_t decodeNum) {
...
#endif /* SIMD_KSCHEME_4BIT_CU_HPP_ */
