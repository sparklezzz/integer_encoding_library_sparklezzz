...
#ifndef SIMD_KSCHEME_1BIT_CU_OPT_HPP_
#define SIMD_KSCHEME_1BIT_CU_OPT_HPP_
...
class SIMD_KScheme_1Bit_CU_opt: public Compressor {
public:
	SIMD_KScheme_1Bit_CU_opt() {
	}
	virtual ~SIMD_KScheme_1Bit_CU_opt() {
	}
...
public:
	...
	virtual std::string getCompressorName() {
		return "SIMD_KScheme_1Bit_CU_opt";
	}
...
template<typename T>
int SIMD_KScheme_1Bit_CU_opt::encode(char* des, const T* src, uint32_t encodeNum) {
	if (encodeNum < 4) {
...
template<typename T>
int SIMD_KScheme_1Bit_CU_opt::decode(T* des, const char* src, uint32_t decodeNum) {
	if (decodeNum < 4) {
...
template<typename T>
int SIMD_KScheme_1Bit_CU_opt::encodeBlock(char* des, const T* src, uint32_t encodeNum) {
...
template<typename T>
int SIMD_KScheme_1Bit_CU_opt::decodeBlock(T* des, const char* src, uint32_t decodeNum) {
...
#endif /* SIMD_KSCHEME_1BIT_CU_OPT_HPP_ */
