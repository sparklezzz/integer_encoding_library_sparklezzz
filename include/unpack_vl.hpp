...
#ifndef UNPACK_VL_HPP_
#define UNPACK_VL_HPP_

namespace paradise {
namespace index {
template<typename T>
void unpack_vl0(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl1(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl2(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int k=0; k<2; k++){
			for (int j=0; j<4; j++) {
...
template<typename T>
void unpack_vl3(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int j=0; j<4; j++) {
			des[j] = src[j] & 0x7;
...
template<typename T>
void unpack_vl4(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int k=0; k<4; k++){
			for (int j=0; j<4; j++) {
...
template<typename T>
void unpack_vl5(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int j=0; j<4; j++) {
			des[j] = src[j] & 0x1f;
...
template<typename T>
void unpack_vl6(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int k=0; k<2; k++){
			for (int j=0; j<4; j++) {
...
template<typename T>
void unpack_vl7(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int j=0; j<4; j++) {
			des[j] = src[j] & 0x7f;
...
template<typename T>
void unpack_vl8(T * des, const uint32_t *src, int blockSize) {
	int i;
	for (i = 0; i < blockSize; i += 128) {
		for (int k=0; k<8; k++){
			for (int j=0; j<4; j++) {
...
template<typename T>
void unpack_vl9(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl10(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl11(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl12(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl13(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl14(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl15(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl16(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl17(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl18(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl19(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl20(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl21(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl22(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl23(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl24(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl25(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl26(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl27(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl28(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl29(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl30(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl31(T * des, const uint32_t *src, int blockSize) {
	int i;
...
template<typename T>
void unpack_vl32(T * des, const uint32_t *src, int blockSize) {
	int i;
