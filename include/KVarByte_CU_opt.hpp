...
#ifndef KVARBYTE_CU_OPT_HPP_
#define KVARBYTE_CU_OPT_HPP_
...
class KVarByte_CU_opt: public Compressor {
public:
	KVarByte_CU_opt() {
	}
	virtual ~KVarByte_CU_opt() {
	}
...
template<typename T>
int KVarByte_CU_opt::encode(char* des, const T* src, uint32_t encodeNum) {
	if (encodeNum < 4) {
...
template<typename T>
int KVarByte_CU_opt::decode(T* des, const char* src, uint32_t decodeNum) {
	if (decodeNum < 4) {
...
template<typename T>
int KVarByte_CU_opt::encodeBlock(char* des, const T* src, uint32_t encodeNum) {
...
/*
template<typename T>
int KVarByte_CU_opt::decodeBlock(T* des, const char* src, uint32_t decodeNum) {
